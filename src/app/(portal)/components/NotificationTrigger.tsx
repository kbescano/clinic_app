...
export default function NotificationTrigger() {
  ...
  // Determine the correct gradient ID based on the current route
  const gradientId = isHomePage ? 'url(#whiteAtelierGradient)' : 'url(#blackAtelierGradient)'
  ...
  return (
    ...
    >
      ...
      {hasNotifications && (
        <span className="absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-[#d7263d] border-[1.5px] border-white dark:border-black text-[7px] text-white font-serif font-bold animate-in zoom-in duration-300 z-10">
      ...
      >
        ...
        {/* BELL ICON: Added dynamic fill based on hasNotifications */}
        <path
          d="M12 22C13.1 22 14 21.1 14 20H10C10 21.1 10.9 22 12 22ZM18 16V11C18 7.93 16.36 5.36 13.5 4.68V4C13.5 3.17 12.83 2.5 12 2.5C11.17 2.5 10.5 3.17 10.5 4V4.68C7.63 5.36 6 7.92 6 11V16L4 18V19H20V18L18 16Z"
          stroke={gradientId}
          fill={hasNotifications ? gradientId : 'none'}
          strokeWidth="1.5"
          strokeLinecap="round"
