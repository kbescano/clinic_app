            ...
            <header className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="flex items-start gap-4 md:gap-5">
                ...
                <div className="space-y-1">
                  <p className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] text-[#595f72] font-serif">
                    Clinical Expertise
                  </p>
                  {/* REDUCED HEADER SIZE: From 3xl/5xl to 20px/24px */}
                  <h2 className="text-[20px] md:text-[24px] font-light font-serif text-[#251101] dark:text-white uppercase leading-none tracking-tight">
                ...
                >
                  ...
                  <div className="p-8 md:p-10 flex flex-col flex-grow border-t border-zinc-100 dark:border-zinc-900">
                    <div className="space-y-2">
                      <p className="text-[8px] md:text-[9px] uppercase tracking-[0.4em] font-serif text-[#595f72] dark:text-zinc-500 ">
                        {specialist.specialization}
                      </p>
                      {/* REDUCED NAME SIZE: From xl/2xl to 14px/15px */}
                      <h3 className="text-[14px] md:text-[15px] font-light font-serif text-[#251101] dark:text-white leading-tight tracking-tighter uppercase transition-colors group-hover:text-zinc-500">
                        {specialist.name}
                      </h3>
                    </div>
